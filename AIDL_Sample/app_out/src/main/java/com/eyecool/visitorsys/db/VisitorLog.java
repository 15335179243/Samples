...
public class VisitorLog implements Parcelable{
    ...
    protected  VisitorLog(Parcel in){
        user_id = in.readString();
        name = in.readString();
        phone = in.readString();
        visitor_type = in.readString();
        match_time = in.readString();
        match_score = in.readString();
        match_img = in.readString();
    ...
    public static final Creator<VisitorLog> CREATOR = new Creator<VisitorLog>() {
        @Override
        public VisitorLog createFromParcel(Parcel source) {
            return new VisitorLog(source);
        }

        @Override
        public VisitorLog[] newArray(int size) {
            return new VisitorLog[size];
        }
    };
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(visitor_type);
        dest.writeString(match_time);
        dest.writeString(match_score);
        dest.writeString(match_img);
