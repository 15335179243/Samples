...
public class AlarmCallBack_PF {
	...
	MapAlarmType[] alarmTypeMap = {new MapAlarmType(NetDEVSDK.NETDEV_ALARM_TYPE_E.NETDEV_ALARM_MOVE_DETECT,"move detect"),
			...
			new MapAlarmType(NetDEVSDK.NETDEV_ALARM_TYPE_E.NETDEV_ALARM_REPORT_DEV_VIDEO_LOSS,"device video loss"),
			new MapAlarmType(NetDEVSDK.NETDEV_ALARM_TYPE_E.NETDEV_ALARM_REPORT_DEV_VIDEO_LOSS_RECOVER,"device video loss recover"),
			...
			new MapAlarmType(NetDEVSDK.NETDEV_ALARM_TYPE_E.NETDEV_ALARM_ALLTIME_FLAG_START,"all time flag start"),
			...
			new MapAlarmType(NetDEVSDK.NETDEV_ALARM_TYPE_E.NETDEV_ALARM_NO_RECOVER_FLAG_START,"no recover flag start"),
			...
			new MapAlarmType(NetDEVSDK.NETDEV_ALARM_TYPE_E.NETDEV_ALARM_DISK_OFFLINE_RECOVER,"disk offline recover"),
			new MapAlarmType(NetDEVSDK.NETDEV_ALARM_TYPE_E.NETDEV_ALARM_DISK_ONLINE_RECOVER,"disk online recover"),
